...
To use these stylesheets, rename the files and netzwerk with the name of your theme.
...
netzwerk-alpha-default-narrow.css  
...
netzwerk-alpha-default-normal.css
...
netzwerk-alpha-default-wide.css
